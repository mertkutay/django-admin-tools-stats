    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('graph_key', models.CharField(help_text='it needs to be one word unique. ex. auth, mygraph', max_length=90, unique=True, verbose_name='graph identifier')),
                ...
                ('type_operation_field_name', models.CharField(blank=True, choices=[('Count', 'Count'), ('Sum', 'Sum'), ('Avg', 'Avg'), ('Max', 'Max'), ('Min', 'Min'), ('StdDev', 'StdDev'), ('Variance', 'Variance')], help_text='choose the type operation what you want to aggregate, ex. Sum', max_length=90, null=True, verbose_name='Choose Type operation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('criteria_fix_mapping', django.contrib.postgres.fields.jsonb.JSONField(blank=True, help_text='a JSON dictionary of key-value pairs that will be used for the criteria', null=True, verbose_name='fixed criteria / value')),
                ...
                ('criteria_dynamic_mapping', django.contrib.postgres.fields.jsonb.JSONField(blank=True, help_text='a JSON dictionary of key-value pairs that will be used for the criteria Ex. "{\'false\': \'Inactive\', \'true\': \'Active\'}"', null=True, verbose_name='dynamic criteria / value')),
                ('created_date', models.DateTimeField(auto_now_add=True, verbose_name='date')),
                ('updated_date', models.DateTimeField(auto_now=True)),
            ],
            options={
